...
public class formvistatratamiento extends javax.swing.JFrame {

    public formvistatratamiento() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        if(evt.getClickCount() == 2){
            ...
            String codigo, nombredeltratamiento, preciodeltratamiento;
            
            codigo = tablalistado.getValueAt(fila, 0).toString();
            nombredeltratamiento = tablalistado.getValueAt(fila, 1).toString();
            preciodeltratamiento = tablalistado.getValueAt(fila, 4).toString(); //en el Ftratamiento el precio es el indice 4
            
            formservicio.txtidtratamiento.setText(codigo);
            formservicio.txttratamiento.setText(nombredeltratamiento);
            formservicio.txtprecioventa.setText(preciodeltratamiento);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(formvistatratamiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new formvistatratamiento().setVisible(true);
            }
        });
    }
